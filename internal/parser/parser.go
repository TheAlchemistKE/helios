...
// parseForExpression parses a for loop expression
func (p *Parser) parseForExpression() ast.Expression {
	...
	fe.Identifier = &ast.Identifier{Token: p.curToken, Value: p.curToken.Literal}
	...
	p.nextToken()
	fe.Iterator = p.parseExpression(LOWEST)
...
// noPrefixParseFnError records an error when a prefix parse function is not found
